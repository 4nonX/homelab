...
export default function EditorPage() {
  ...
  const url = `http://***REMOVED***:3000/${username}`;
            ...
            <div className="space-y-6">
              ...
              {portfolio.projects?.map((proj: any, index: number) => (
                <div key={index} className="p-6 bg-[#0F1419] border border-gray-700 rounded-lg space-y-4">
                  ...
                  <div>
                    <label className="block mb-1 text-sm text-gray-400">Project Image</label>
                    <div className="flex items-center gap-4">
                      {proj.image && (
                        <img 
                          src={proj.image} 
                          alt="Project" 
                          className="w-32 h-32 object-cover rounded border-2 border-gray-700"
                        />
                      )}
                      <button
                        onClick={() => {
                        ...
                        className="px-4 py-2 bg-[#1C2128] border border-gray-700 rounded-lg text-white hover:border-gray-600"
                      >
                    ...
                    <p className="text-xs text-gray-500 mt-2">Max 2MB. 16:9 recommended.</p>
                  </div>
