...
export default function DarkOceanTheme({ portfolio, labels, onContactClick }: any) {
  return (
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {portfolio.email && (
                  <a
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-cyan-600/30 backdrop-blur-md border border-cyan-500/50 text-white rounded-lg hover:bg-cyan-600/40 transform hover:scale-105 transition-all shadow-lg shadow-cyan-500/20"
                  >
                ...
                <button
                  ...
                  className="px-6 py-3 bg-teal-600/30 backdrop-blur-md border border-teal-500/50 text-white rounded-lg hover:bg-teal-600/40 transform hover:scale-105 transition-all"
                >
                  {labels.contact}
                </button>
              </div>
        ...
        {portfolio.summary && (
          <section className="py-12 px-4">
            <div className="max-w-4xl mx-auto">
              <div className="bg-slate-900/70 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-cyan-500/20">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {portfolio.skills.map((skill: string, index: number) => (
                  <span
                    key={index}
                    className="px-5 py-2 bg-cyan-600/20 backdrop-blur-md border border-cyan-500/30 text-cyan-200 rounded-full font-medium shadow-lg hover:bg-cyan-600/30 transform hover:scale-110 transition-all"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                {portfolio.experience.map((job: any, index: number) => (
                  <div key={index} className="bg-slate-900/70 backdrop-blur-md rounded-2xl shadow-2xl p-6 border border-cyan-500/20">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                {portfolio.education.map((edu: any, index: number) => (
                  <div key={index} className="bg-slate-900/70 backdrop-blur-md rounded-2xl shadow-2xl p-6 border border-teal-500/20">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {portfolio.projects.map((project: any, index: number) => (
                  <div key={index} className="bg-slate-900/70 backdrop-blur-md rounded-2xl shadow-2xl p-6 border border-cyan-500/20 transform hover:scale-105 transition-all">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                {portfolio.languages_spoken.map((lang: any, index: number) => (
                  <div key={index} className="bg-slate-900/70 backdrop-blur-md rounded-xl shadow-xl p-4 min-w-[150px] text-center border border-teal-500/20">
